...
//
//  Created by Yosuke Sakurai on 4/13/22.
//
...
class NotificationCell: UITableViewCell { 
    ...
    func configure() {
        guard let viewMdoel = viewModel else { return }
        
        profileImageView.sd_setImage(with: viewMdoel.profileImageUrl)
        postImageView.sd_setImage(with: viewMdoel.postImageUrl)
